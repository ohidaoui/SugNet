...
<img src="sugnet_architecture.png" width=70%, style="display:block; margin: 0 auto;"/>
  
  
## Some examples of the segmentation
 
<img src="test0.png" width=70%, style="display:block; margin: 0 auto;"/>
  
<img src="test1.png" width=70%, style="display:block; margin: 0 auto;"/>